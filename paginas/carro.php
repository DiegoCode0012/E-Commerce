...
<div class="PadreFlex" style="margin-top:30px">
  <div class="tablaP">
...
<div id="mensajeNoHay"></div>
  ...
  <tr>
    <td colspan="2"><a style="width: 50%" href="pago.php"  class="btn btn-danger" >CONTINUAR</a></td>
  </tr>
  <tr>
    <td colspan="2"><a style="width: 30%" href="prueba.php"  class="btn btn-primary" >Volver</a></td>
  </tr>
    </table>
</div>
